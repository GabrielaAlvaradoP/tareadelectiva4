...
for index1 in range(13):
    if horasExtras[index1] > 5 :
       monto[index1] =monto[index1] + (monto[index1] * (5 /100) )#aqui iba en donde esta el 5 la palabra bono1
    else:
       monto[index1] =monto[index1] + (monto[index1] * (15 /100) )#aqui iba en donde esta el 15 la palabra bono2
